...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Keystone v$VERSION</title>
      <link>https://github.com/domus-apps/keystone/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/keystone/releases/download/v$VERSION/Keystone.zip"
        $SIGNATURE_ATTRS
